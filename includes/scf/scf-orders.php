                ...
                array(
                    ...
                    'sub_fields' => array(
                        ...
                        array(
                            ...
                            'type' => 'text',
                            'instructions' => 'ID da tarefa de face swap retornado pela API',
                            'required' => 0,
                        ),
                        array(
                            'key' => 'field_generated_illustration',
                            'label' => 'Ilustração da Página (FaceSwap)',
                        ...
                        array(
                            'key' => 'field_falai_request_id',
                            'label' => 'FAL.AI Request ID',
                            'name' => 'falai_request_id',
                            'type' => 'text',
                            'instructions' => 'ID da requisição do FAL.AI Nano Banana Pro retornado pela API',
                            'required' => 0,
                        ),
                        array(
                            'key' => 'field_generated_illustration_falai',
                            'label' => 'Ilustração da Página (FAL.AI)',
                            'name' => 'generated_illustration_falai',
                            'type' => 'image',
                            'instructions' => 'Ilustração final desta página, após o processamento com FAL.AI Nano Banana Pro',
                            'required' => 0,
                            'return_format' => 'array',
                            'preview_size' => 'full',
                            'library' => 'all',
